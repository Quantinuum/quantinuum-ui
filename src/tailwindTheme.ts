...
export const tailwindTheme = {
  ...
  theme: {
    ...
    extend: {
      // Pin to Tailwind v3's default stacks so the v4 upgrade renders identical fonts.
      fontFamily: {
        sans: [
          "ui-sans-serif",
          "system-ui",
      ...
      // Pin to Tailwind v3's default scale; v4 shifted the shadow scale by one step.
      boxShadow: {
